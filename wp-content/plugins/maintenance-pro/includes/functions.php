		...
		if (!empty($single_video_link)) {
			...
			if (strpos($single_video_link, 'youtube')) {
				...
				if(!wp_is_mobile()) {
					...
					$iframe_build = '<iframe frameborder="0" allowfullscreen="1" height="100%" width="100%" src="http://www.youtube.com/embed/'.$youtube_vars['v'].'?autoplay=1&amp;loop=1&amp;controls=0&amp;showinfo=0&amp;autohide=1&amp;modestbranding=1&amp;wmode=transparent&amp;enablejsapi=1"></iframe>';
